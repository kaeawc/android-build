...
fun SettingsScreen(onLogout: () -> Unit, onGuestModeNavigateToLogin: () -> Unit = {}) {
    ...
    Scaffold(topBar = { ProfileTopAppBar(scrollProgress = scrollProgress) }) { paddingValues ->
        Column(
            modifier =
...
fun SettingsScreenMainPreview() {
    ...
    JPTheme(darkTheme = isDarkMode) { SettingsScreen(onLogout = { /* Preview logout action */ }) }
}
