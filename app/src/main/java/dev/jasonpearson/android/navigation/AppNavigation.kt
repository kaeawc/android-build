                        ...
                        is SettingsDestination -> {
                            ...
                            when {
                                ...
                                !userPreferences.isAuthenticated -> {
                                    ...
                                    Log.d(
                                        TAG,
                                        "User authenticated, navigating to: $parsedDestination",
                                    )
                                    parsedDestination
                                }
                            }
    ...
    NavDisplay(
        ...
        entryProvider =
            entryProvider {
                    ...
                    Box(modifier = Modifier.destinationSemanticModifier<HomeDestination>()) {
                        HomeScreen(
                            ...
                            onNavigateToSlides = { slideIndex ->
                                Log.d(
                                    TAG,
                                    "Navigating to SlidesScreen with slideIndex: $slideIndex",
                                )
                                NavigationTracker.trackNavigation(
                                    "HomeScreen",
                                    "SlidesScreen",
                ...
                //                Log.d(
                //                    TAG,
                //                    "Navigated to SlidesScreen with slideIndex:
                ...
                //                        onNavigateBack = {
                //                          Log.d(TAG, "Navigating back from SlidesScreen to
                // HomeScreen")
                //                          NavigationTracker.trackNavigation(
                    ...
                    Box(modifier = Modifier.destinationSemanticModifier<SettingsDestination>()) {
                        SettingsScreen(
                            onLogout = {
                                Log.d(
                                    TAG,
                                    "Logout initiated from settings, navigating to LoginScreen",
                                )
                                if (userPreferences.isGuestMode) {
                                    userPreferences.isGuestMode = false
                                } else {
                            ...
                            onGuestModeNavigateToLogin = {
                                Log.d(
                                    TAG,
                                    "Guest mode to login from settings, navigating to LoginScreen",
                                )
                                userPreferences.isGuestMode = false
                                NavigationTracker.trackNavigation(
                                    "SettingsScreen",
